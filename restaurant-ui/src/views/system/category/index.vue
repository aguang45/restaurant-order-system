<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="菜品类别" prop="categoryName">
        <el-input
    ...
    <el-table stripe v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
<!--      <el-table-column label="类别id" align="center" prop="categoryId" />-->
      <el-table-column label="菜品类别" align="center" prop="categoryName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="菜品类别" prop="categoryName">
          <el-input v-model="form.categoryName" placeholder="请输入菜品类别" />
        </el-form-item>
        <el-form-item label="排序" prop="categorySort">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        categoryName: [
          { required: true, message: "菜品类别不能为空", trigger: "blur" }
        ],
        categorySort: [
  ...
  methods: {
    ...
    handleSelectionChange(selection) {
      ...
      this.names = selection.map(item => item.categoryName)
    ...
    handleDelete(row) {
      ...
      const categoryName = row.categoryName || this.names;
      this.$modal.confirm('是否确认删除类别为"' + categoryName + '"的数据项？').then(function() {
