<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="对应的订单id" prop="orderId">
        <el-input
          v-model="queryParams.orderId"
          placeholder="请输入对应的订单id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="对应的菜品id" prop="dishId">
        <el-input
          v-model="queryParams.dishId"
          placeholder="请输入对应的菜品id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="菜品数量" prop="dishQuantity">
        <el-input
          v-model="queryParams.dishQuantity"
          placeholder="请输入菜品数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单详情id" align="center" prop="orderDetailId" />
      <el-table-column label="对应的订单id" align="center" prop="orderId" />
      <el-table-column label="对应的菜品id" align="center" prop="dishId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="对应的订单id" prop="orderId">
          <el-input v-model="form.orderId" placeholder="请输入对应的订单id" />
        </el-form-item>
        <el-form-item label="对应的菜品id" prop="dishId">
          <el-input v-model="form.dishId" placeholder="请输入对应的菜品id" />
        </el-form-item>
        <el-form-item label="菜品数量" prop="dishQuantity">
          <el-input v-model="form.dishQuantity" placeholder="请输入菜品数量" />
        </el-form-item>
        <el-form-item label="小计金额" prop="subtotal">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        orderId: [
          { required: true, message: "对应的订单id不能为空", trigger: "blur" }
        ],
        dishId: [
          { required: true, message: "对应的菜品id不能为空", trigger: "blur" }
        ],
        dishQuantity: [
